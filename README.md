...
- livres, feuille, stylos, connaissances...
- élèves, professeurs...
- salle de classe, cdi, self, bar, bureau...
- en mettant en commun nos recherches, dialoguer, ecrire
- débat, mise en commun des informations...
- bruit, désaccord, materiel delabré...
- support

# livre
- feuilles, recherches, connaissances/apprendre/découvrir
- toutes personnes sachant lire
- livres
- lecture, retenir, comprendre, partager
...
#bloomfire
- Intégration avec d'autres outils, Outils de recherche avancée, Analyse pour mesurer l'engagement et l'utilisation des connaissances, systèmes de questions/réponses pour permettre l'interaction entre les membres, fonctionnalités de création et partage de contenu 
   multimédia.
